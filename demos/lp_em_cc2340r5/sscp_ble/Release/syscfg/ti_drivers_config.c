...
GPIO_PinConfig gpioPinConfigs[26] = {
    ...
    GPIO_CFG_INPUT_INTERNAL | GPIO_CFG_IN_INT_NONE | GPIO_CFG_PULL_UP_INTERNAL, /* CONFIG_GPIO_BUTTON_1 */
    /* Owned by CONFIG_BUTTON_0 as Button GPIO */
    GPIO_CFG_INPUT_INTERNAL | GPIO_CFG_IN_INT_NONE | GPIO_CFG_PULL_UP_INTERNAL, /* CONFIG_GPIO_BUTTON_0 */
...
static const Button_HWAttrs ButtonHWAttrs[CONFIG_BUTTON_COUNT] = {
    ...
    {
        .gpioIndex = CONFIG_GPIO_BUTTON_0,
    ...
    {
        .gpioIndex = CONFIG_GPIO_BUTTON_1,
        .pullMode = Button_PULL_UP,
        .internalPullEnabled = 1,
    },
};
